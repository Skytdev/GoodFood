 ...
 */
final class Version20220611110051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, lastname VARCHAR(180) NOT NULL, firstname VARCHAR(180) NOT NULL, birthday DATE NOT NULL, phone VARCHAR(15) NOT NULL, civility VARCHAR(10) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE employee (id INT AUTO_INCREMENT NOT NULL, franchise_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, lastname VARCHAR(180) NOT NULL, firstname VARCHAR(180) NOT NULL, birthday DATE NOT NULL, phone VARCHAR(15) NOT NULL, civility VARCHAR(10) NOT NULL, is_active TINYINT(1) NOT NULL, created_at DATE NOT NULL, desactivated_at DATE DEFAULT NULL, UNIQUE INDEX UNIQ_5D9F75A1E7927C74 (email), INDEX IDX_5D9F75A1523CAB89 (franchise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE facture_row (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, order_final_id INT NOT NULL, quantity INT NOT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_E1403B947294869C (article_id), INDEX IDX_E1403B94F22CF99C (order_final_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ingredient (id INT NOT NULL, name VARCHAR(50) NOT NULL, quantity INT NOT NULL, unit VARCHAR(50) NOT NULL, stock_min INT NOT NULL, allergen VARCHAR(255) DEFAULT NULL, extra_price DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ingredient_product (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, ingredient_id INT NOT NULL, quantity INT NOT NULL, is_extra TINYINT(1) NOT NULL, limit_quantity INT NOT NULL, INDEX IDX_D27D0F6B4584665A (product_id), INDEX IDX_D27D0F6B933FE08C (ingredient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, state_id INT NOT NULL, customer_id INT NOT NULL, order_notice_id INT DEFAULT NULL, franchise_id INT NOT NULL, address_id INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_F52993985D83CC1 (state_id), INDEX IDX_F52993989395C3F3 (customer_id), UNIQUE INDEX UNIQ_F5299398BB523B53 (order_notice_id), INDEX IDX_F5299398523CAB89 (franchise_id), INDEX IDX_F5299398F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE order_notice (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, score INT NOT NULL, INDEX IDX_8B8255179395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product_category_franchise (product_category_id INT NOT NULL, franchise_id INT NOT NULL, INDEX IDX_53409966BE6903FD (product_category_id), INDEX IDX_53409966523CAB89 (franchise_id), PRIMARY KEY(product_category_id, franchise_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE role_employee (role_id INT NOT NULL, employee_id INT NOT NULL, INDEX IDX_774C9390D60322AC (role_id), INDEX IDX_774C93908C03F15C (employee_id), PRIMARY KEY(role_id, employee_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE product_category_franchise ADD CONSTRAINT FK_53409966BE6903FD FOREIGN KEY (product_category_id) REFERENCES product_category (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE product_category_franchise ADD CONSTRAINT FK_53409966523CAB89 FOREIGN KEY (franchise_id) REFERENCES franchise (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE role_employee ADD CONSTRAINT FK_774C9390D60322AC FOREIGN KEY (role_id) REFERENCES role (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE role_employee ADD CONSTRAINT FK_774C93908C03F15C FOREIGN KEY (employee_id) REFERENCES employee (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE role_employee DROP FOREIGN KEY FK_774C93908C03F15C');
        ...
        $this->addSql('ALTER TABLE product_category_franchise DROP FOREIGN KEY FK_53409966523CAB89');
        ...
        $this->addSql('ALTER TABLE product_category_franchise DROP FOREIGN KEY FK_53409966BE6903FD');
        ...
        $this->addSql('ALTER TABLE role_employee DROP FOREIGN KEY FK_774C9390D60322AC');
